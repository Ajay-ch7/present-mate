...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const hintsPanel = document.getElementById("pm-hints-panel");
    const hintsContent = document.getElementById("pm-hints-content");
    const prevBtn = document.getElementById("pop-prev-btn");
    const nextBtn = document.getElementById("pop-next-btn");
    const slideText = document.getElementById("pop-slide-text");
    // State
